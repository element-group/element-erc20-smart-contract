...
contract("ElementToken", (accounts) => {
  it("should have the name Element Token", () => {
    return ElementToken.deployed().then((instance) => {
        return instance.name.call();
      })
      .then((name) => {
        assert.equal(name, "Element Token", "Element Token wasn't the name")
      });
  });

  it("should have the symbol ELM", () => {
    return ElementToken.deployed().then((instance) => {
        return instance.symbol.call()
      })
      .then((symbol) => {
        assert.equal(symbol, "ELM", "ELM wasn't the symbol")
      })
  })
  ...
  it("should allow transfer() of Grains by address owner when unpaused", () => {
    ...
    return ElementToken.deployed().then((instance) => {
      ...
      .then((balance) => {
        ...
        return meta.transfer(accounts[1], xferAmt, {
          from: accounts[0]
        })
      })
      .then(() => {
  ...
  it("should not allow transfer() when _to is null", () => {
    ...
    return ElementToken.deployed().then((instance) => {
        meta = instance
        return meta.transfer(null, xferAmt, {
          from: accounts[0]
        })
      })
      .then(assert.fail)
  ...
  it("should not allow transfer() when _to is 0x0000000000000000000000000000000000000000", () => {
    ...
    return ElementToken.deployed().then((instance) => {
        meta = instance
        return meta.transfer("0x0000000000000000000000000000000000000000", xferAmt, {
          from: accounts[0]
        })
      })
      .then(assert.fail)
  ...
  it("should not allow transferFrom() when _to is null", () => {
    ...
    return ElementToken.deployed().then((instance) => {
      ...
      .then(() => {
        return meta.transferFrom(accounts[0], null, xferAmt, {
          from: accounts[1]
        })
      })
      .then(assert.fail)
  ...
  it("should not allow transferFrom() when _to is 0x0000000000000000000000000000000000000000", () => {
    ...
    return ElementToken.deployed().then((instance) => {
      ...
      .then(() => {
        return meta.transferFrom(accounts[0], "0x0000000000000000000000000000000000000000", xferAmt, {
          from: accounts[1]
        })
      })
      .then(assert.fail)
